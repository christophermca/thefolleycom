<?php get_header(); ?>
		    ...
		    <?php if( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">				
					...
					$portfolioClientDescription = get_post_meta($post->ID, 'tz_portfolio_client_description', true); 
					...
					if( !empty($portfolioClientDescription) ) {
            		                echo '<h5>' . __('Client Description:', 'framework') . '</h5>';
            		                echo '<span>' . $portfolioClientDescription . '</span><br />';
            		            }
